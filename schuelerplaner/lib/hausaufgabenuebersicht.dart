...
class _HausaufgabeKarteState extends State<HausaufgabeKarte> {
  ...
  String zeitDifferenzInTagen(DateTime vergleichsDatum) {
    ...
    if (difference.inHours < 24) {
      return difference.inHours.abs().toString() + ' Stunden ';
    }
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                child: Text(
                  widget.hausaufgabe.abgabeZeitpunkt.day.toString().padLeft(2, '0') + '.' + widget.hausaufgabe.abgabeZeitpunkt.month.toString().padLeft(2, '0'),
              ...
              Container(
                ...
                child: Text(
                  'Noch ' + zeitDifferenzInTagen(widget.hausaufgabe.abgabeZeitpunkt) + 'Zeit',
                  style: TextStyle(fontSize: 15),
                ),
              ),
            ] 
